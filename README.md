...
2.First we will make the header portion and in that we use grid and flex to place the items 
3. Now we will make the sidebar component
4. Make the functionality of the menu toggle part we use Redux toolkit
